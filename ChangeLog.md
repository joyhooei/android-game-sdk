...
- For detail please read wiki about IPN for each payment method [https://github.com/appota/android-game-sdk/wiki/Passive-Confirmation-via-IPN](https://github.com/appota/android-game-sdk/wiki/Passive-Confirmation-via-IPN)